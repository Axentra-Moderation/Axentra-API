/*
  ...
  - The values [BAN] on the enum `LogAction` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "LogAction_new" AS ENUM ('SOFTBAN', 'UNBAN', 'KICK', 'MUTE', 'UNMUTE', 'WARN', 'PARDON', 'PURGE');
